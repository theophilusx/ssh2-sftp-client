...
describe('25bulk-upload: uploadDir tests with put', function () {
  let sftp;
...
describe('25bulk-upload: uploadDir tests with fastPut', function () {
  let sftp;
...
describe('25bulk-upload: Uploaddir bad path tests', function () {
  let sftp;
...
describe('25bulk-upload: Upload with various promise limits', function () {
