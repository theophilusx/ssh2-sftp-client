...
describe('16uploaddir: uploadDir tests', function () {
  let sftp;
...
describe('16uploaddir B: uploadDir tests with fastPut', function () {
  let sftp;
...
describe('16uploaddir C: Partial file upload', function () {
  let sftp;
...
describe('16uploaddir D: Uploaddir bad path tests', function () {
  let sftp;
