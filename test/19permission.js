...
const { permissionSetup, permissionCleanup } = require('./hooks/permission-hook.js');
...
if (config.testServer !== 'windows') {
  describe('19permission: Bad permission tests', function () {
    ...
    describe('19permission B: No access to remote object', function () {
      let sftp;
