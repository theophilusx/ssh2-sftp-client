...
export async function permissionSetup(client, sftpUrl, localUrl) {
  try {
    chmodSync(makeLocalPath(localUrl, 'no-access.txt'), 0o000);
...
export async function permissionCleanup(client, sftpUrl) {
  try {
