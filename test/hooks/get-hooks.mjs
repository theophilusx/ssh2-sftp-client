...
import { mkdirSync, chmodSync, unlinkSync, rmdirSync } from 'node:fs';

export async function getSetup(client, sftpUrl, localUrl) {
  try {
...
export async function getCleanup(client, sftpUrl, localUrl) {
  try {
