export async function chmodSetup(client, sftpUrl) {
  try {
    await client.put(Buffer.from('chmod testing'), `${sftpUrl}/chmod-test.txt`, {
      encoding: 'utf8',
    });
...
export async function chmodCleanup(client, sftpUrl) {
  try {
